...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        setForm({
          ...form,
          image: `data:image/jpeg;base64,${data.photo[0]}`,
          imag1: `data:image/jpeg;base64,${data.photo[1]}`,
        })
        console.log(form)
      } catch (error) {
        console.log(error)
  ...
  return (
    <section className="max-w-7xl mx-auto ">
      <div>
        <h1 className="font-extrabold text-[#222328] text-[3.4rem]">Create</h1>
        <p className="mt-2 text-[#666e75] text-[1.6rem] max-w-[50rem]">
          Create maginative and visually stunning images generated by DALL-E AI
